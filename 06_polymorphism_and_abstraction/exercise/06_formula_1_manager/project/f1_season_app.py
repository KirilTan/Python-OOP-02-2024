from ex_1_and_2.project import MercedesTeam
from ex_1_and_2.project import RedBullTeam
...
class F1SeasonApp:
    ...
    def get_race_results(self, race_name: str, red_bull_pos: int, mercedes_pos: int) -> str:
        team_ahead: str = "Red Bull" if red_bull_pos < mercedes_pos else "Mercedes"
